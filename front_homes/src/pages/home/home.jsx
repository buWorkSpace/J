...
function Home() {
  ...
  // 검색 및 정렬 로직
  let filteredBuildings = buildingList.filter((b) =>
        ...
        <section className="home_building_outer_box">
          ...
          <div className="home_building_grid">
            {currentItems.map((building) => (
              <a
                href={`/detail?id=${building.id}`}
                key={building.id}
                className="building_card_link"
              >
                <div className="building_card">
                  <div className="image_wrapper">
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill={
                          favorites.includes(building.id) ? "#e74c3c" : "none"
                        }
                        stroke={
                          favorites.includes(building.id) ? "#e74c3c" : "white"
                        }
                        strokeWidth="2"
                      >
                  ...
                  <div className="building_card_info">
                    ...
                    <span className="building_card_rating">
                      <span className="star_icon">★</span> {building.rating} (
